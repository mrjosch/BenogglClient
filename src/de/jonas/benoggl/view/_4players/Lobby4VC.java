package de.jonas.benoggl.view._4players;
...
public class Lobby4VC extends ViewController {
    ...
    public void updateView(LobbySnapshot snapshot) {
        ...
        player4_name.setTextFill(Paint.valueOf("black"));
        ...
        player4_name.setText(snapshot.player4Name);
        ...
        } else if(mainApp.name.equals(snapshot.player4Name)) {
            player4_name.setTextFill(Paint.valueOf("green"));
        }
    }

    private void showInGameView() {
        mainApp.showReizen4Scene();
    }
    ...
    public void setPlayer4_name(String name) {
