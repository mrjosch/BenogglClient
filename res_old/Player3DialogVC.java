...
public class Player3DialogVC {
    ...
    @FXML
    private TextField name_Player3;

    /**
     * The constructor.
     * The constructor is called before the initialize() method.
     */
    public Player3DialogVC() {
    }
    ...
    public void handleOk() {
        if(isInputValid()) {
            mainApp.setGame(new Game(new Player(name_Player1.getText()),new Player(name_Player2.getText()),new Player(name_Player3.getText())));
            showInGameView();
        }
    }
    ...
    private boolean isInputValid() {
        ...
        if (name_Player1.getText() == null || name_Player1.getText().length() == 0 || name_Player2.getText() == null || name_Player2.getText().length() == 0 || name_Player3.getText() == null || name_Player3.getText().length() == 0) {
